...
/*
 * Only use one of the other - either SpaceUtils or SpaceAccessor
 * SpaceAccessor was created a a breakdown into an object oriented format
 * to understand each part of the initialization of a space application.
 */
